...
public class Main {
    public static void main(String[] args) {
        ...
        //anytime you need to use a method from the Math class just start Math and let the list pop up Math
        ...
        //Strings == collections of characters enclosed by quotation marks "lnfainrg"
        //              023456789 -- position
        String myStr = "Howdy yall";
        // Strings are immutable

        out.println(myStr.length());    //total quantity
        out.println(myStr.indexOf("y"));    //where is it in the string -- first occurance
        ...
        out.println(myStr.substring(4));    //returns a portion of the original string beginning at the given location all the way to the end
